...
console.log('');
  ...
  static displayHelp() {
    ...
    console.log('\n' + chalk.bold.cyan('Debate Strategy:'));
    console.log('  /normal-debate     - Standard 2-round debate (default)');
    console.log('  /extra-debate      - Extended debate up to 10 rounds (exits on consensus)');
    console.log('  /unlimited-debate  - Unlimited rounds until perfect consensus');
